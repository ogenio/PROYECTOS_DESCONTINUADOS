...
function_verify () {
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/ogenio/PROYECTOS_DESCONTINUADOS/master/GENERADOR-VPS-MX/Install/Vercion")
...
wget -O /etc/versin_script_new https://raw.githubusercontent.com/ogenio/PROYECTOS_DESCONTINUADOS/master/GENERADOR-VPS-MX/Install/Vercion &>/dev/null
msg -bar2
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/ogenio/PROYECTOS_DESCONTINUADOS/master/GENERADOR-VPS-MX/Install/trans &> /dev/null
